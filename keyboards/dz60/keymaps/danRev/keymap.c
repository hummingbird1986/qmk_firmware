...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL]=LAYOUT(
                 ...
                 LT(_MCO,KC_CAPS),KC_LALT,KC_LGUI,           KC_NO,KC_SPC,KC_NO,        KC_RGUI,KC_RALT,KC_NO,KC_RCTL,KC_DEL),
    ...
    [_HHKB]=LAYOUT(
                   _______,  KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,_______,_______,_______,_______,_______,_______,_______,_______,_______,
                   _______,  KC_F6,  KC_F7,  KC_F8,  KC_F9, KC_F10,_______,_______,_______,_______,_______,  KC_UP,_______,KC_EJCT,
                   _______, KC_F11, KC_F12, KC_F13, KC_F14, KC_F15,_______,_______,KC_HOME,KC_PGUP,KC_LEFT,KC_RIGHT,_______,
